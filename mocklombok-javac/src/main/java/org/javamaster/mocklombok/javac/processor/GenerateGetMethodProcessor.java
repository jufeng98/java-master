...
import org.javamaster.mocklombok.javac.anno.GenerateGetMethod;
 ...
 * @date 2019/1/23
 */
@SupportedAnnotationTypes("org.javamaster.mocklombok.javac.anno.GenerateGetMethod")
...
public class GenerateGetMethodProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        set.forEach(element -> {
            logger.info("element has GenerateGetMethod annotation:" + element.getKind().name() + " " + element);
            ...
            jcTree.accept(new TreeTranslator() {
                ...
                public void visitClassDef(JCTree.JCClassDecl jcClassDecl) {
                    ...
                    jcVariableDeclList.forEach(jcVariableDecl -> {
                        logger.info(element + " Field:" + jcVariableDecl.getName() + " has been processed");
