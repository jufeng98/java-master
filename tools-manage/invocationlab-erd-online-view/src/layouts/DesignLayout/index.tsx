  ...
  return (
    <WaterMark content={['ERD Online', 'V4.0.7']}>
      <ProLayout
        ...
        bgLayoutImgList={[
          {
            src: '/invocationlab-erd-online-view/ant-1.png',
            left: 85,
            bottom: 100,
            height: '303px',
          },
          ...
          {
            src: '/invocationlab-erd-online-view/ant-3.png',
            bottom: 0,
            left: 0,
            width: '331px',
          },
        ...
        onMenuHeaderClick={(e) => location = location.origin + '/invocationlab-erd-online-view/project/recent'}
        ...
        menuItemRender={(item, dom) => {
          return (
            ...
            item.path?.startsWith('http') || item.exact ?
              <a href={item.path} target={'_blank'} style={{ display: 'none' }}>
                {dom}
              </a>
              :
              <div
              ...
              >
                <Link to={item?.path || '/project/recent'}>{dom}</Link>
              </div>
