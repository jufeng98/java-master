...
export default () => {
  ...
  const data = [
    ...
    },
    {
      key: 'JSON',
      title: '导出JSON',
      subTitle: <Tag color="blue">JSON</Tag>,
      avatar: <FileLock theme="filled" size="18" fill="#DE2910" strokeWidth={2} />,
      content: (
        <div style={{ marginLeft: '45px' }}>导出JSON格式的文本</div>
      ),
    },
    {
      key: 'Html',
    ...
    },
    {
      key: 'PDF',
      title: '导出PDF',
      subTitle: <Tag color="blue">PDF</Tag>,
      avatar: <FileWord theme="filled" size="18" fill="#DE2910" strokeWidth={2} />,
      content: (
        <div style={{ marginLeft: '45px' }}>导出PDF文件，包含表元数据和关系图</div>
      ),
    },
    // {
    //   key: 'Word',
